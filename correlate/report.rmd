...
# 2015-09-15: added lncRNA:splice-site binding score to integrated data
...
coverage.upstream<-setNames(unlist(alply(alignments
                                        ...
                                        ,function(alignment)
                                          coverage[(coverage[,1]==alignment[1,7])  # coverage txid == aligned target txid
                                                  &(coverage[,2]==alignment[1,13]) # coverage type == upstream feature type
                                                  &(coverage[,3]==alignment[1,14]) # coverage idx  == upstream feature idx
                                                  ,4                               # get coverage score
                                                  ]
                                        )
                                  )
                           ,unlist(alply(alignments[,c(7,13,14)]                   # label with aligned target txid
                                        ,1                                         # and upstream feature type & idx
                                        ,paste
                                        ,collapse="."
                                        )
                                  )
...
coverage.downstream<-setNames(unlist(alply(alignments
                                        ...
                                        ,function(alignment)
                                          coverage[(coverage[,1]==alignment[1,7])  # coverage txid == aligned target txid
                                                  &(coverage[,2]==alignment[1,15]) # coverage type == downstream feature type
                                                  &(coverage[,3]==alignment[1,16]) # coverage idx  == downstream feature idx
                                                  ,4                               # get coverage score
                                                  ]
                                        )
                                  )
                           ,unlist(alply(alignments[,c(7,15,16)]                   # label with aligned target txid
                                        ,1                                         # and downstream feature type & idx
                                        ,paste
                                        ,collapse="."
                                        )
                                  )
...
coverage<-setNames(cbind(alignments[,c(1,7,13:17)]
                        ,coverage.lnc_rnas
                        ,coverage.upstream
                        ,coverage.downstream
                        )
